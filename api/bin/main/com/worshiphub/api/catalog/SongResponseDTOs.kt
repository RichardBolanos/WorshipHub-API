...
data class SongResponse(
        ...
        val id: UUID,
        @Schema(description = "Song title", example = "Amazing Grace") val title: String,
        @Schema(description = "Artist or composer name", example = "John Newton")
        val artist: String?,
        @Schema(description = "Musical key", example = "G") val key: String?,
...
data class AttachmentResponse(
        ...
        @Schema(description = "Attachment name", example = "Lead Sheet PDF") val name: String,
        @Schema(description = "Attachment URL", example = "https://example.com/sheet.pdf")
        val url: String,
        @Schema(description = "Attachment type", example = "PDF") val type: String
)
...
data class CommentResponse(
        ...
        val content: String,
        @Schema(description = "Comment creation timestamp") val createdAt: LocalDateTime
)
